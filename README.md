...
To visualize the signature variant distribution across sample groups over specific siganture segments, use the *Plot_signature_cluster.py* script within */GSEXP/utilities/py_scripts/* folder. Note that *numpy*,*pandas* and *matplotlib* packages are required to execute this script.
```
